...
export const metadata: Metadata = {
  title: "Soluciones DaaS (Device as a Service) | Renta de Computadores",
  description: "Modelo DaaS para empresas: Renta de computadores Mac y PC con soporte incluido. Reduce CAPEX y garantiza continuidad operativa.",
  alternates: {
    canonical: '/portafolio/daas',
  },
  openGraph: {
    title: "Soluciones DaaS | Tecnología bajo control",
    description: "Device as a Service: Tecnología moderna sin inversión inicial. Mantenimiento y soporte incluido.",
    url: 'https://www.macpower.com.co/portafolio/daas',
  ...
  return (
    <div className="daas-theme">
      <ServiceStructuredData 
        ...
        description="Modelo de renta de computadores y equipos tecnológicos para empresas con soporte y renovación incluidos."
        serviceType="DaaS"
      />
