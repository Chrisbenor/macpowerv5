...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/images/macpower-logo-color.svg' }], // Should be a service-specific hero image ideally
  },
};
  ...
  return (
    <div className="valor-it-theme">
      <ServiceStructuredData 
        ...
        description="Servicios de infraestructura IT (IaaS), Ciberseguridad (SOC), Ciber Recuperación y Protección multicapa para empresas."
